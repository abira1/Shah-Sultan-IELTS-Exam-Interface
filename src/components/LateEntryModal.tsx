    ...
    >
      <div className="bg-white rounded-2xl shadow-2xl max-w-2xl w-full overflow-hidden animate-fadeIn">
        ...
        <div className="bg-gradient-to-r from-orange-500 to-red-500 p-6">
          <div className="flex items-center gap-4">
            ...
            <div className="text-white">
              <h2 className="text-2xl font-bold">⚠️ Exam In Progress</h2>
              <p className="text-orange-100 text-sm mt-1">This exam has already started</p>
            </div>
          </div>
        </div>
        ...
        <div className="p-8">
          {/* Exam Information */}
          <div className="mb-6">
            <h3 className="text-xl font-bold text-gray-900 mb-2">{examName}</h3>
            <p className="text-sm text-gray-600">Exam Code: <span className="font-mono font-semibold">{examCode}</span></p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mb-6">
            ...
            <div className="bg-blue-50 border border-blue-200 rounded-lg p-4">
              <div className="flex items-center gap-2 mb-2">
                ...
                <h4 className="text-sm font-semibold text-blue-900">Started At</h4>
              </div>
            ...
            <div className="bg-purple-50 border border-purple-200 rounded-lg p-4">
              <div className="flex items-center gap-2 mb-2">
                ...
                <h4 className="text-sm font-semibold text-purple-900">Duration</h4>
              </div>
          ...
          <div className="bg-gradient-to-br from-orange-50 to-red-50 border-2 border-orange-300 rounded-xl p-6 mb-6">
          ...
          <div className="flex flex-col sm:flex-row gap-4">
            <button
              onClick={onGoBack}
              className="flex-1 flex items-center justify-center gap-2 px-6 py-4 border-2 border-gray-300 rounded-lg font-semibold text-gray-700 hover:bg-gray-50 transition-all duration-200"
            ...
            <button
              onClick={onEnterExam}
              className="flex-1 flex items-center justify-center gap-2 px-6 py-4 bg-gradient-to-r from-orange-500 to-red-500 text-white rounded-lg font-semibold hover:from-orange-600 hover:to-red-600 transition-all duration-200 shadow-lg hover:shadow-xl"
